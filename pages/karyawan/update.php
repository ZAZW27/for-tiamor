              ...
              <div class="col-md-12">
                <div class="form-container">
                  <form method="POST" action="crud/aksi-update.php">
                    ...
                    $query = mysqli_query($cons, "SELECT * FROM tbl_user WHERE id_user='$id'");
                    ...
                    <div class="wrapping">
                      <div class="boxing">
                        <div class="inputbox">
                            ...
                            <input value="<?=$u['nama_user']?>" type="text" class="form-control" id="nama" placeholder="" name="nama" required />
